...
**TKTK: Describe churchbells here.**
...
```
* * * * * ubuntu bash /home/ubuntu/apps/churchbells/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|churchbells|tweet|`location`||
|churchbells|facebook|`location`||
|churchbells|email|`location`||
|churchbells|new-comment||
|churchbells|open-share-discuss||
|churchbells|close-share-discuss||
|churchbells|summary-copied||
|churchbells|featured-tweet-action|`action`|
|churchbells|featured-facebook-action|`action`|
